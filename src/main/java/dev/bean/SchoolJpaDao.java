...
import dev.event.StudentCoursePayload;
import dev.model.BaseEntity;
import dev.model.Course;
import dev.model.Person;
import dev.model.Student;
import dev.model.Teacher;
import dev.qualifier.DataRepository;
import dev.qualifier.StudentAdded;
import dev.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see dev.bean.SchoolDao#searchStudents(dev.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
